/* HACK - changed table name to 'product' to match Java app expectations */

/*
Deployment script for Docker.AtSea.Database
...
GO
:setvar DatabaseName "AtSeaDB"
:setvar DefaultFilePrefix "Docker.AtSea.Database"
...
END
GO
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '3a2e9b8f-dfd8-4be5-9a25-9ce54dcbc353')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('3a2e9b8f-dfd8-4be5-9a25-9ce54dcbc353')
...
PRINT N'Inserted Product seed data';
